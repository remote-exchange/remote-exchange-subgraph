...
export function wethAddress(): Address {
  if (network == 'matic') {
    ...
    return Address.fromString('0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6');
  } else {
...
export function usdcAddress(): Address {
  if (network == 'matic') {
    ...
    return Address.fromString('0xD87Ba7A50B2E7E660f678A895E4B72E7CB4CCd9C');
  } else {
    log.critical("UNKNOWN NETWORK {}", [network])
    return Address.fromString(ADDRESS_ZERO);
  }
...
export function usdcWethPairAddress(): Address {
  if (network == 'matic') {
    ...
    return Address.fromString('0xB888ecB5C1B4E557e8CefeEeEBe8018DC564ea18');
  } else {
    log.critical("UNKNOWN NETWORK {}", [network])
    return Address.fromString(ADDRESS_ZERO);
  }
...
export function whitelisted(): Address[] {
  if (network == 'matic') {
    ...
    return [
      wethAddress(),
      Address.fromString('0xD87Ba7A50B2E7E660f678A895E4B72E7CB4CCd9C'), // USDC
      Address.fromString('0xdc31Ee1784292379Fbb2964b3B9C4124D8F89C60'), // DAI
    ]
  } else {
    log.critical("UNKNOWN NETWORK {}", [network])
    return [Address.fromString(ADDRESS_ZERO)];
